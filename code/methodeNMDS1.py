...
def methodeNMDS1(nbcandidats, tabOrders):
    """Fonction de calcul des coordinées par Non Metric Multidimentional Scaling 1D"""
    ...
    for i in range(len(tabOrders)):
        ...
        for j in range(1, len(tabOrders[i])):
            ...
            if (tabOrders[i][j] != -1):
                ...
                # Demultiplication par le nombre de votants
